...
visualizer<T>::visualizer(bst<T> tree, int node_length /* = -1 */, int space_length /* = -1 */)
{
	...
	tree_height_ = get_tree_height(tree_root_);//compte le nombre de noeud avec enfant
	tree_nodes_ = get_nodes_count(tree_height_) - 1;//compte le nombre de noeud total
